...
class StageCActivity : AppCompatActivity() {
    private lateinit var binding: ActivityStageCBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityStageCBinding.inflate(layoutInflater)
        ...
        faucets = listOf(
            ...
            binding.btnFaucet10, binding.btnFaucet11, binding.btnFaucet12
        )
