...
import com.kiiis.wudhuyuk.databinding.ActivityStageABinding
import com.kiiis.wudhuyuk.settings.FontScaleSetting
import com.kiiis.wudhuyuk.ui.main.MainActivity
import kotlin.random.Random

class StageAActivity : AppCompatActivity() {
    private lateinit var binding: ActivityStageABinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityStageABinding.inflate(layoutInflater)
    ...
    private fun endGame() {
        ...
        binding.btnNextStage.setOnClickListener {
            ...
            val intent = Intent(this, StageBActivity::class.java)
